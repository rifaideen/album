...
<div class="media" id="comment_<?php echo $id.$comment->id; ?>">
                    ...
                    <?php if ($canWrite): ?>
                        <li>
                            ...
                            echo AjaxButton::widget([
                                ...
                                'ajaxOptions' => [
                                    'type' => 'POST',
                                    'success' => new yii\web\JsExpression("function(html){ $('.preferences .dropdown').removeClass('open'); $('#comment_editarea_" . $id.$comment->id . "').replaceWith(html); $('#comment_input_" . $id.$comment->id . "_contenteditable').focus(); }"),
                                    'url' => Url::to(['/album/comment/edit', 'contentModel' => $comment->object_model, 'contentId' => $comment->object_id, 'id' => $comment->id]),
                                ],
                                'tag' => 'a'
                            ]);
                            ?>
    ...
    <div class="media-body">
        ...
        <div class="content" id="comment_editarea_<?php echo $id.$comment->id; ?>">
