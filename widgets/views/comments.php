...
?>
<div class="well well-small comment-container" style="display:none;overflow-y:scroll;" id="comment_<?php echo $id; ?>">
    ...
    <?php echo \humhub\modules\album\widgets\Form::widget(['object' => $object]); ?>
